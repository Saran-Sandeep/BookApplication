...
namespace BookApplication1.DataAccess.Migrations
{
    ...
    [Migration("20251202053557_AddRazorpayFieldsInOrderHeader")]
    partial class AddRazorpayFieldsInOrderHeader
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookApplication1.Models.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookApplication1.Models.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookApplication1.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookApplication1.Models.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookApplication1.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("BookApplication1.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookApplication1.Models.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BookApplication1.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("BookApplication1.Models.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
